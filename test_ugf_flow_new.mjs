#!/usr/bin/env node
/**
 * UGF 4-Phase End-to-End Smoke Test with configured vault
 */

import { ethers } from 'ethers';

const BACKEND    = 'http://localhost:4000/api';
const VAULT_ADDR = '0x96aB36541BCEadF7560738BF0B91324E56D3d3eD';
...
// Encode donate(causeId=4, amount=100 MUSD)
...
const calldata = iface.encodeFunctionData('donate', [4n, donateAmount]);
...
(async () => {
  console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('  UGF End-to-End Smoke Test (New Vault)');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  // Ensure deployer has approved the vault
